...
@section('header')
    ...
    <h1>
        Create Mailbox
        <small>One can create mailbox settings</small>
    </h1>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <!-- Email name -->
                    <div class="col-xs-4 form-group {!! $errors->has('email_name') ? 'has-error' : ''!!}"
                         id="email_name_error">
                    ...
                    <!-- password -->
                    <div class="col-xs-4 form-group {!! $errors->has('password') ? 'has-error' : ''!!}"
                         id="password_error">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2 form-group">
                        <br/>
                        <input type="checkbox" name="imap_validate" id="imap_validate" checked>&nbsp; Validate
                        certificates from TLS/SSL server
                    </div>
                </div>
            </div>
            <div class="box-header with-border">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2 form-group">
                        <br/>
                        <input type="checkbox" name="smtp_validate" id="smtp_validate" checked>&nbsp; Validate
                        certificates from TLS/SSL server
                    </div>
                </div>
            </div>
...
// Ajax communicating to backend for further Checking/Saving the details
            $.ajax({
                ...
                error: function (response) {
                    $("#close").trigger("click");
                    var errorsHtml = "<div class='alert alert-danger alert-dismissable'> <i class='fa fa-ban'> </i> <b> Alert!</b><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><div id='alert-message'>(response error)" + response + " Unable to process the details </div></div>";
                    $('#alert').empty();
