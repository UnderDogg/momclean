        ...
        <div class="box box-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 form-group {!! $errors->has('password') ? 'has-error' : ''!!}"
                        ...
                        <input type="password" name="password" class='form-control' id='password'
                               value="{!! Crypt::decrypt($emails->password) !!}">
                    </div>
                </div>
            </div>
            <div class="box-header with-border">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2 form-group">
                        <br/>
                        <input type="checkbox" name="imap_validate"
                               id="imap_validate" <?php if (strpos($emails->fetching_encryption,
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2 form-group">
                            <input type="checkbox" name="sending_status"
                                   id="sending_status" <?php if ($emails->sending_status == '1') {
                                echo 'checked="checked"';
                            } ?> > Enable
                        </div>
                    </div>
                ...
                <!-- sending hoost -->
                    ...
                    <div class="col-xs-2 form-group">
                        <br/>
                        <input type="checkbox" name="smtp_validate"
                               id="smtp_validate" <?php if ($emails->smtp_validate == "on") {
                            echo "checked";
                        } ?> >&nbsp; Validate certificates from TLS/SSL server
                    </div>
                </div>
